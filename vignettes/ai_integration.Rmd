...
TextAnalysisR provides AI and NLP features via local and web-based providers.
...
Generate content grounded in validated topic terms (not generic AI knowledge):
...
| `run_rag_search()` | Question-answering over the document corpus (RAG) |
