...
**Outlier Reduction Strategies:** HDBSCAN may assign some documents as outliers (-1).
Use `outlier_strategy` to control reassignment (follows BERTopic methodology):
...
Set `outlier_threshold` to control minimum confidence for reassignment (default: 0.0).
