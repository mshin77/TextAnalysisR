...
Primary language: English. Preprocessing and STM work with many languages (stopwords for 50+); embeddings and AI features can be multilingual; spaCy and the sentiment lexicons are English-only.
