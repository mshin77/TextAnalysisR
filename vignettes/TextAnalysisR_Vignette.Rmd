...
### Analyze and Visualize Word Proportions Across a Continuous Variable

#### Word Proportions Across a Continuous Variable Plot
...
word_proportion_results <- 
  TextAnalysisR::word_proportion(
    dfm_object,
    stm_model = stm_15,
...
#### Generalized Linear Model with B-splines and Logit Link Table
