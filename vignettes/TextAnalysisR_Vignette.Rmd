...
```{r, fig.alt= "Word Frequency Plot After Removing Stopwords"}
...
```{r, fig.alt= "Word Frequency Plot After Removing Common Words"}
...
```{r, fig.alt= "Word Frequency Plot After Lemmatizing Tokens"}
library(spacyr)
