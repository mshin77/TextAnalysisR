...
### Analyze and Visualize Trends in Word Frequency

#### Word Frequency Trend Plot

```{r, fig.alt= "Word Frequency Across a Continuous Variable"}
df <- TextAnalysisR::SpecialEduTech
united_tbl <- TextAnalysisR::unite_text_cols(df, listed_vars = c("title", "keyword", "abstract"))
tokens <- TextAnalysisR::preprocess_texts(united_tbl, text_field = "united_texts")
dfm_object <- quanteda::dfm(tokens)
...
word_frequency_trends_results <- 
  TextAnalysisR::word_frequency_trends(
    dfm_object,
    stm_model = stm_15,
