...
Visualize semantic relationships as interactive networks with community detection.
...
<details>
<summary><strong>Embedding-Based Document Networks</strong></summary>

When `feature_type = "embeddings"`, networks show document-to-document relationships:
...
- Lower threshold → more connections, may be noisy
