...
**Usage:** Choose method based on analysis goals. Words and n-grams are faster and interpretable. Embeddings capture deeper meaning but require more computation. All methods use cosine similarity for comparison.
...
Embeddings are cached and shared across Document Similarity, Topic Modeling, and Semantic Search when the same provider and model are reused. See [AI Integration](ai_integration.html) for provider/model setup.
