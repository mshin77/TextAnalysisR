    ...
    content = function(file) {
      isolate(tryCatch({
        ...
        report_lines <- c(
          ...
          "",
          paste("Generated:", format(Sys.time(), "%Y-%m-%d %H:%M:%S")),
          paste("TextAnalysisR Version:", utils::packageVersion("TextAnalysisR")),
          "",
          "",
      ...
      report_lines <- c(report_lines,
        ...
        "",
        paste0("Shin, M. (2026). TextAnalysisR: A text mining workflow tool (R package version ",
               utils::packageVersion("TextAnalysisR"), ")"),
