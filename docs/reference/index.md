...
Word frequency, keywords, and readability metrics
...
Lexicon and embedding-based sentiment scoring
...
Document similarity, clustering, and embeddings
...
STM, embedding-based, and hybrid topic models
...
Python/reticulate setup and checking
...
Quality assessment and cross-validation
...
App interface components and notifications

- [`show_completion_notification()`](https://mshin77.github.io/TextAnalysisR/reference/show_completion_notification.md)
  : Show Completion Notification
- [`show_dfm_instructions_modal()`](https://mshin77.github.io/TextAnalysisR/reference/show_dfm_instructions_modal.md)
  : Show DFM Setup Instructions Modal
- [`show_dfm_required_modal()`](https://mshin77.github.io/TextAnalysisR/reference/show_dfm_required_modal.md)
  : Show DFM Requirement Modal
- [`show_error_notification()`](https://mshin77.github.io/TextAnalysisR/reference/show_error_notification.md)
  : Show Error Notification
- [`show_guide_modal()`](https://mshin77.github.io/TextAnalysisR/reference/show_guide_modal.md)
  : Show Guide Modal Dialog from HTML File
- [`show_loading_notification()`](https://mshin77.github.io/TextAnalysisR/reference/show_loading_notification.md)
  : Show Loading/Progress Notification
- [`show_no_dfm_notification()`](https://mshin77.github.io/TextAnalysisR/reference/show_no_dfm_notification.md)
  : Show No DFM Notification
- [`show_no_feature_matrix_notification()`](https://mshin77.github.io/TextAnalysisR/reference/show_no_feature_matrix_notification.md)
  : Show Feature Matrix Notification
- [`show_preprocessing_required_modal()`](https://mshin77.github.io/TextAnalysisR/reference/show_preprocessing_required_modal.md)
  : Show Generic Preprocessing Required Modal
- [`show_preprocessing_steps_modal()`](https://mshin77.github.io/TextAnalysisR/reference/show_preprocessing_steps_modal.md)
  : Show Preprocessing Steps Modal
- [`show_unite_texts_required_notification()`](https://mshin77.github.io/TextAnalysisR/reference/show_unite_texts_required_notification.md)
  : Show Unite Texts Required Notification
- [`show_warning_notification()`](https://mshin77.github.io/TextAnalysisR/reference/show_warning_notification.md)
  : Show Warning Notification
- [`show_web_banner()`](https://mshin77.github.io/TextAnalysisR/reference/show_web_banner.md)
  : Show Web Deployment Banner
- [`remove_notification_by_id()`](https://mshin77.github.io/TextAnalysisR/reference/remove_notification_by_id.md)
  : Remove Notification by ID
- [`get_dfm_setup_instructions()`](https://mshin77.github.io/TextAnalysisR/reference/get_dfm_setup_instructions.md)
  : Generate DFM Setup Instructions Text
- [`check_web_deployment()`](https://mshin77.github.io/TextAnalysisR/reference/check_web_deployment.md)
  : Check Deployment Environment
- [`check_feature()`](https://mshin77.github.io/TextAnalysisR/reference/check_feature.md)
  : Check Feature Status
- [`get_feature_status()`](https://mshin77.github.io/TextAnalysisR/reference/get_feature_status.md)
  : Get Feature Status
- [`require_feature()`](https://mshin77.github.io/TextAnalysisR/reference/require_feature.md)
  : Require Feature
- [`plot_error()`](https://mshin77.github.io/TextAnalysisR/reference/plot_error.md)
...
- [`create_analysis_datatable()`](https://mshin77.github.io/TextAnalysisR/reference/create_analysis_datatable.md)
  : Create Formatted Analysis Data Table

## Security & Accessibility

Input validation and WCAG compliance

- [`validate_file_upload()`](https://mshin77.github.io/TextAnalysisR/reference/validate_file_upload.md)
...
- [`sanitize_text_input()`](https://mshin77.github.io/TextAnalysisR/reference/sanitize_text_input.md)
  : Sanitize Text Input
- [`check_rate_limit()`](https://mshin77.github.io/TextAnalysisR/reference/check_rate_limit.md)
  : Check Rate Limit
- [`log_security_event()`](https://mshin77.github.io/TextAnalysisR/reference/log_security_event.md)
  : Log Security Event
- [`validate_api_key()`](https://mshin77.github.io/TextAnalysisR/reference/validate_api_key.md)
  : Validate OpenAI API Key Format
- [`calculate_contrast_ratio()`](https://mshin77.github.io/TextAnalysisR/reference/calculate_contrast_ratio.md)
  : Web Accessibility Utility Functions
- [`check_wcag_contrast()`](https://mshin77.github.io/TextAnalysisR/reference/check_wcag_contrast.md)
  : Check WCAG Contrast Compliance
- [`generate_aria_label()`](https://mshin77.github.io/TextAnalysisR/reference/generate_aria_label.md)
  : Generate ARIA Label
- [`create_sr_text()`](https://mshin77.github.io/TextAnalysisR/reference/create_sr_text.md)
  : Create Screen Reader Text
- [`validate_keyboard_navigation()`](https://mshin77.github.io/TextAnalysisR/reference/validate_keyboard_navigation.md)
  : Validate Keyboard Navigation
- [`check_alt_text()`](https://mshin77.github.io/TextAnalysisR/reference/check_alt_text.md)
...
- [`TextAnalysisR`](https://mshin77.github.io/TextAnalysisR/reference/TextAnalysisR-package.md)
  [`TextAnalysisR-package`](https://mshin77.github.io/TextAnalysisR/reference/TextAnalysisR-package.md)
  : TextAnalysisR: Text Mining Workflow Tool
- [`` `%>%` ``](https://mshin77.github.io/TextAnalysisR/reference/pipe.md)
  : Pipe operator
- [`run_text_workflow()`](https://mshin77.github.io/TextAnalysisR/reference/run_text_workflow.md)
...
- [`find_topic_matches()`](https://mshin77.github.io/TextAnalysisR/reference/find_topic_matches.md)
  : Find Similar Topics
- [`analyze_topic_evolution()`](https://mshin77.github.io/TextAnalysisR/reference/analyze_topic_evolution.md)
  : Analyze Semantic Evolution
- [`generate_semantic_topic_keywords()`](https://mshin77.github.io/TextAnalysisR/reference/generate_semantic_topic_keywords.md)
...
- [`compute_topic_alignment()`](https://mshin77.github.io/TextAnalysisR/reference/compute_topic_alignment.md)
  : Compute Topic Alignment Using Cosine Similarity
- [`compute_hybrid_quality_metrics()`](https://mshin77.github.io/TextAnalysisR/reference/compute_hybrid_quality_metrics.md)
  : Compute Hybrid Model Quality Metrics
- [`combine_keywords_weighted()`](https://mshin77.github.io/TextAnalysisR/reference/combine_keywords_weighted.md)
