...
including PCA, t-SNE, and UMAP. UMAP runs directly on inputs with 1000
or fewer features (e.g. dense embeddings); PCA pre-reduction applies to
wider inputs and to the PCA and t-SNE methods.
